...
@synthesize rImageBig, rInfo, rNameLong, abbreviation, payGrade, natoCode, collarImg;
...
- (void)viewDidLoad
{
    ...
    abbreviation.text = rInfo.abbreviation;
    payGrade.text = rInfo.payGrade;
    natoCode.text = rInfo.natoCode;
