...
@synthesize age, altitude, runtime, pullups, pftClass, gender, crunches, flexHang, score, status, calculateButton;
...
- (void)viewDidLoad
{
    ...
    //Pull-ups text field
    pullups.layer.cornerRadius = 5.0f;
    pullups.layer.borderColor = [[UIColor lightGrayColor]CGColor];
    pullups.layer.borderWidth = 1.0f;
    
    //Crunches text field
    crunches.layer.cornerRadius = 5.0f;
    crunches.layer.borderColor = [[UIColor lightGrayColor]CGColor];
    crunches.layer.borderWidth = 1.0f;
    
    //Run time text field
    runtime.layer.cornerRadius = 5.0f;
    runtime.layer.borderColor = [[UIColor lightGrayColor]CGColor];
    runtime.layer.borderWidth = 1.0f;
...
-(IBAction)onClick:(id)sender
{
    ...
    else if ([pullups.text length] == 0)
    {
        UIAlertView *pullUpAlert = [[UIAlertView alloc]initWithTitle:@"Invalid Entry" message:@"Please enter the amount of pull-ups you performed." delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        
        [pullUpAlert show];
    }
    else if ([crunches.text length] == 0)
    {
        UIAlertView *crunchesAlert = [[UIAlertView alloc]initWithTitle:@"Invalid Entry" message:@"Please enter the amount of crunches you performed." delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        
        [crunchesAlert show];
    }
    else if ([runtime.text length] == 0)
    {
        UIAlertView *runAlert = [[UIAlertView alloc]initWithTitle:@"Invalid Entry" message:@"Please enter your run time." delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
